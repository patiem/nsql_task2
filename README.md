...
Display on console all tasks. 5 points
Display overdue tasks. 5 points
Display all tasks with a specific category (query parameter). 5 points
Display all subtasks related to tasks with a specific category (query parameter). 5 points
Perform insert/update/delete of the task. 5 points
Perform insert/update/delete all subtasks of a given task (query parameter). 10 points
Support full-text search by word in the task description. 10 points
Support full-text search by a sub-task name. 5 points
